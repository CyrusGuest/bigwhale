...
const faqs = [
  ...
  },
  {
    ...
    a: 'We don’t know, and neither does anyone else — so we won’t publish a payback target. Distributions depend entirely on trading volume, which varies unpredictably and can fall to zero. The token’s market price also moves independently of rewards, so your position can lose value faster than distributions accrue. Treat XRPVM as a speculative asset whose rewards are a variable bonus, not as an income product with a schedule.',
  },
  {
    q: 'Where exactly does the XRP come from?',
    a: 'From the 5% fee charged on each completed trade of the token. Fees are converted to XRP and pooled; four fifths of each fee is distributed to holders pro-rata each hour, and one fifth funds liquidity. No part of any reward comes from new buyers’ principal, token emissions, or lending out pooled funds — the pool’s inflows and outflows are public XRPL transactions you can audit.',
  },
  {
  ...
  },
  {
    ...
    a: 'No. Hold XRPVM in a self-custodied XRPL wallet and distributions arrive automatically. There is no staking contract, no claim interface, and no lockup period. If you sell, you simply stop receiving future distributions — nothing you have already received is affected.',
  },
  {
